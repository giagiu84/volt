# LA BIBBIA DI VOLT
### L'universo di Lumina, della Frattura e dei due Custodi

> **Questo file è l'unica fonte.**
> Quando si parla della storia di VOLT — con una persona, con un'intelligenza
> artificiale, in un post, in un video — si parte da qui e si torna qui.
> Se una cosa non è scritta in questo file, **non è ancora vera**.
> Se una cosa è scritta qui e nel gioco è diversa, ha ragione il gioco: si
> corregge il file.
...
|---|---|
| **[GIOCO]** | è già dentro il gioco, giocabile oggi. Non si cambia senza cambiare il codice |
...
Tutto in VOLT nasce da una sola idea, e niente deve contraddirla:

> **La tensione è la spinta. La corrente è il flusso.
> Nessuna energia serve a qualcosa finché non trova una strada per scorrere.
> Nemmeno quella che lega due persone.**

Da qui viene ogni cosa: i poteri, la minaccia, l'oggetto che salva il mondo, il
nemico, il finale. Quando si inventa qualcosa di nuovo per questo universo, la
domanda da farsi è una sola: **c'entra con la tensione, con la corrente o con
un legame?** Se la risposta è no, quella cosa non appartiene a VOLT.

I due nomi del gioco sono le due metà del principio:

- **VOLT** è la tensione: la forza accumulata, ferma, che preme.
...
**VOLT è il potere, non la persona. Non si nasce VOLT: lo si diventa.**
Due Custodi vegliano sul Nucleo di Lumina. Quello che il giocatore sceglie
assorbe l'energia e diventa VOLT; l'altro viene catturato dal Divoratore mentre
cerca di proteggerlo.

Non si scrive mai «VOLT, il ragazzo» o «Volt e Lyra». Si scrive «Aren, che è
diventato VOLT» oppure «Lyra, che è diventata VOLT».
...
alto, raffica rapida, colpi più leggeri, meno resistenza. Nel gioco: 4 cuori,
corsa 336, danno per secondo 8,2 (stessa possibilità di arrivare in fondo, modo
...
1. **ECHO-0 non è malvagio, e alla fine non muore.** È un essere che ha paura di
   smettere di esistere. Chi lo scrive come "il cattivo che vuole distruggere
   tutto" ha sbagliato personaggio.
2. **La Frattura non si tappa, non si sigilla a forza, non si distrugge.** Si
   chiude dandole un circuito. Ogni soluzione che assomiglia a "spariamo forte"
   è fuori canone.
3. **VOLT non è il nome di nessuno.**
4. **Nei filmati non si parla.** L'audio sul telefono può essere bloccato: ogni
   scena deve funzionare muta. Le frasi importanti si scrivono a schermo, in
   maiuscolo, poche parole.
5. **Niente sangue, niente morte in scena, niente crudeltà.** Il gioco lo aprono
   anche i bambini. I mostri si disfano in luce.
...
## 7. Come si scrive (lessico ufficiale)

| Si scrive così | Non così |
|---|---|
| **VOLT** (sempre maiuscolo, è un potere) | Volt, il Volt |
| **AREN**, **LYRA** (maiuscolo nel gioco, Aren e Lyra nei testi) | Arén, Lira |
| **AMPERE** (maiuscolo), la lanterna | Ampère, ampere |
| **la Frattura** (maiuscolo) | la frattura |
...
| **il Comandante** (i boss dell'atto I) | il boss |
| **il settore** (i livelli) | il livello, lo stage |

Il tono dei testi del gioco è **breve, diretto, senza retorica**. Le frasi delle
creature della Frattura sono in maiuscolo e non superano le due righe.

---

## 8. L'aspetto

Stile: **colorato, morbido, moderno** — forme arrotondate con contorno scuro,
occhi grandi, ombre soffuse, colori vivi. È il look "mobile premium", non il
pixel art e non il neon anni '80: quella strada è stata provata e scartata.

- Contorno di tutto: `#20183f`
...
all'altra. Ordine consigliato: prima tutte le immagini di un personaggio, poi
l'altro.

Formula che ha funzionato:
> *cinematic 3D animated short, colorful stylized game cinematic, [scena],
> character consistent with reference image, dynamic camera, dramatic lighting,
> purple energy rift, 16:9*

---

## 9. Dove vive la storia
...
Non si producono quattro opere insieme: si scrive **una storia sola**,
raccontata prima col gioco e con Instagram.

Il segnale che dirà se l'universo esiste davvero non lo diamo noi. È il giorno
in cui qualcuno, dopo aver giocato, chiede **chi è ECHO-0**.
...
- **Due Custodi giocabili** con statistiche diverse; il gioco cambia nomi,
  generi e finale da solo.
- **Quattro filmati**: due rapimenti e due liberazioni.
- Missioni: caccia, sopravvivenza, tracce del Custode rapito, bersagli,
  assalto, fuga.
- **VOLT Rush** a comando, **navicella**, 12 potenziamenti + 5 leggendari.
- Difficoltà: i primi cinque settori sono la porta d'ingresso, dal sesto
  arrivano gli **élite** e la curva si impenna.
- **Oltre la Frattura** (infinito, si sblocca finendo la campagna): ogni tre
